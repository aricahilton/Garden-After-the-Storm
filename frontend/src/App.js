...
const IMAGES = {
  ...
  album: `${BACKEND_URL}/api/static/album_cover_new.png`,
...
forever unhidden.`
  },
  {
    ...
    duration: "8:02",
    file: "track_06_seven_faces_of_love.wav",
...
to our staccato embrace`
  },
  {
    ...
    duration: "6:25",
    file: "track_12_song_of_the_gypsy.wav",
    ...
    <div className="app" data-testid="app">
      ...
      <nav className="nav" data-testid="navigation">
        ...
        <div className={`nav-links ${mobileMenuOpen ? 'mobile-open' : ''}`}>
          ...
          <button onClick={() => scrollToSection("photos")} data-testid="nav-photos">PHOTOS</button>
      ...
      {/* Photos Section */}
      <section className="photos-section" id="photos" data-testid="photos-section">
        <p className="section-label">Gallery</p>
        <h2>PHOTOS</h2>
        <p className="photos-description">Album release party & art exhibition opening — photos coming soon.</p>
        <div className="photos-grid" data-testid="photos-grid">
          <div className="photos-placeholder">
            ...
            <p>Photos from the album release party & art exhibition coming soon</p>
          </div>
        </div>
      </section>
